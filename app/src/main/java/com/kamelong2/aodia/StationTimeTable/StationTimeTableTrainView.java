package com.kamelong2.aodia.StationTimeTable;
...
public class StationTimeTableTrainView extends LinearLayout implements View.OnClickListener {
    ...
    public StationTimeTableTrainView(Context context) {
        super(context);
        View layout = LayoutInflater.from(context).inflate(R.layout.old_station_timetable_train, this);
    ...
    public void onClick(View view) {
        ...
        ((AOdiaActivity)getContext()).openTrainEdit(fileNum,diaNum,direct,trainNum);
    }
}
