...
public class OuDiaFile {
     ...
     * AnySecondIncDec1
     */
    private int anySecondIncDec1 = 5;
    /**
     * AnySecondIncDec2
     */
    private int anySecondIncDec2 = 15;
    /**
     * FileType
     */
    ...
    private OuDiaFile(JPTI jpti, Service service) {
        super();
        /*
        //fileType
        fileType = "OuDia.1.02";
    ...
    public ArrayList<Integer> getBorders() {
        ...
        for (int i = 0; i < getStationNum(); i++) {
            ...
            if (getStation(i).border()) {
                ...
                int nextBorder = -1;
                for (int j = i + 1; j < getStationNum(); j++) {
                    if (getStation(j).getName().equals(borderName)) {
                        nextBorder = j;
                        break;
                    }
                }
                ...
                if (i + 1 < getStationNum()) {
                    String borderName2 = getStation(i + 1).getName();
                    int beforeBorder = -1;
                    for (int j = 0; j < i; j++) {
                        if (getStation(j).getName().equals(borderName2)) {
                            beforeBorder = j;
                            break;
                        }
                    }
        ...
        borderStation.add(getStationNum() - 1);
