 ...
 */
class TimeTableFragment:Fragment(),AOdiaFragmentInterface{
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
                ...
                object : GestureDetector.SimpleOnGestureListener() {
                    ...
                    override fun onScroll(motionEvent: MotionEvent, motionEvent1: MotionEvent, vx: Float, vy: Float): Boolean {
                        ...
                        for(i in 0 until trainLinear.childCount){
                            (trainLinear.getChildAt(i) as TrainViewGroup).scrollBy(vy,false)
                        }
                        return false
                    }
        ...
        for(i in 0 until diaFile.getTrainNum(diaIndex,direction)){
            trainLinear.addView(TrainViewGroup(activity,diaFile.getTrain(diaIndex,direction,i),direction))
        }
